            ...
            while (escenaActual == CARGAR_PROGRESO)
            {
                ...
                if (IsMouseButtonPressed(MOUSE_LEFT_BUTTON))
                {
                    ...
                    if (mousePosition.x >= click_nivel1_x_inicial && mousePosition.x <= click_nivel1_x_final &&
                        mousePosition.y >= click_nivel1_y_inicial && mousePosition.y <= click_nivel1_y_final)
                    {
                        cargarprogreso("partida1.txt", &nivel_del_usuario, &contador_1, &contador_1_skin, &contador_2, &contador_2_skin, &contador_3, &contador_3_skin, &contador_4, &contador_4_skin, &cursor_final, &verificador_de_pregunta_de_tutorial);
                ...
                if (IsMouseButtonPressed(MOUSE_LEFT_BUTTON))
                {
                    ...
                    if (mousePosition.x >= click_nivel2_x_inicial && mousePosition.x <= click_nivel2_x_final &&
                        mousePosition.y >= click_nivel2_y_inicial && mousePosition.y <= click_nivel2_y_final)
                    {
                        cargarprogreso("partida2.txt", &nivel_del_usuario, &contador_1, &contador_1_skin, &contador_2, &contador_2_skin, &contador_3, &contador_3_skin, &contador_4, &contador_4_skin, &cursor_final, &verificador_de_pregunta_de_tutorial);
                        MostrarCargandoProgreso();
                    }
                }
                const int click_nivel3_x_inicial = 1366;
                ...
                if (IsMouseButtonPressed(MOUSE_LEFT_BUTTON))
                {
                    ...
                    if (mousePosition.x >= click_nivel3_x_inicial && mousePosition.x <= click_nivel3_x_final &&
                        mousePosition.y >= click_nivel3_y_inicial && mousePosition.y <= click_nivel3_y_final)
                    {
                        cargarprogreso("partida3.txt", &nivel_del_usuario, &contador_1, &contador_1_skin, &contador_2, &contador_2_skin, &contador_3, &contador_3_skin, &contador_4, &contador_4_skin, &cursor_final, &verificador_de_pregunta_de_tutorial);
                        MostrarCargandoProgreso();
                    }
                }
                if (IsKeyPressed(KEY_J))
